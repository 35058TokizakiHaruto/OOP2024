...
namespace Test02 {
    ...
    class Program {
        ...
        private static void Exercise03(List<int> numbers) {
            var sortenumbers = numbers.OrderBy(x => x).ToArray();
        ...
        private static void Exercise04(List<int> numbers) {
            var selected = numbers.Select(x => x.ToString());
        ...
        private static void Exercise06(List<Person> persons) {
            var target = persons.Where(p => p.Height < 170).Average(p => p.Height);
        ...
        private static void Exercise07(List<Person> persons) {
            var selected = persons.Select(s => s.Height <= 70);
        ...
        private static void Exercise08(List<Person> persons) {
            var mount = persons.Where(b => b.Name.Contains("山"));
