...
namespace Section03 {
    public partial class Form1 : Form {
        ...
        //非同期メソッド(イベントハンドラ)
        private async void by_16_7_Click(object sender, EventArgs e) {
            toolStripStatusLabel1.Text = "";
        ...
        private async void by_16_8_Click(object sender, EventArgs e) {
            toolStripStatusLabel1.Text = "";
        ...
        private async void by_16_9_Click(object sender, EventArgs e) {
            toolStripStatusLabel1.Text = "";
